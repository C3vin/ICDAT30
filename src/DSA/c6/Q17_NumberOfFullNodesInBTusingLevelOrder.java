...
public class Q17_NumberOfFullNodesInBTusingLevelOrder {
	...
	public int numberOfFullNodesInBTusingLevelOrder(TreeNode root) {
		int count = 0;
	...
	public static void main(String[] args) {
		Q17_NumberOfFullNodesInBTusingLevelOrder obj = new Q17_NumberOfFullNodesInBTusingLevelOrder();
		...
		System.out.println(obj.numberOfFullNodesInBTusingLevelOrder(p1));
	}
}
