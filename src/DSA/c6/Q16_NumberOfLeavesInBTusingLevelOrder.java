...
public class Q16_NumberOfLeavesInBTusingLevelOrder {
	...
	public int numberOfLeavesInBTusingLevelOrder(TreeNode root) {
		int count = 0;
	...
	public static void main(String[] args) {
		Q16_NumberOfLeavesInBTusingLevelOrder obj = new Q16_NumberOfLeavesInBTusingLevelOrder();
		...
		System.out.println(obj.numberOfLeavesInBTusingLevelOrder(p1));
	}
}
